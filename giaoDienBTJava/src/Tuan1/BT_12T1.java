 ...
 * @author menbt
 */
public class BT_12T1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Cho số tự nhiên N bất kỳ, tính tổng\nS= 1+ 1/2! + 1/3! + … + 1/N!\nN nhập từ bàn phím");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_12T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
