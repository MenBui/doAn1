 ...
 * @author menbt
 */
public class BT_1T1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("In ra màn hình tất cả hợp số nhỏ hơn N\nN nhập từ bàn phím");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_1T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
