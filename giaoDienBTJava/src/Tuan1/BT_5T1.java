 ...
 * @author menbt
 */
public class BT_5T1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("In ra màn hình tất cả các số nguyên tố từ N đến M đồng thời chia hết cho 3 , 5 và 7\nN, M nhập từ bàn phím\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_5T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
