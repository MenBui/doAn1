 ...
 * @author menbt
 */
public class BT_11T1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_11T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
