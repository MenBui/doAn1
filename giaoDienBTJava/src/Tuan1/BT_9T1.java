 ...
 * @author menbt
 */
public class BT_9T1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Cho số tự nhiên N>1 bất kỳ (đã gán trước đó). In ra khai triển thành tích các số\nnguyên tố tính từ nhỏ đến lớn VD: 9-->3.3; 12-->2.2.3\nN nhập từ bàn phím");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_9T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
