 ...
 * @author menbt
 */
public class BT_4T1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("In ra màn hình tất cả số nhỏ hơn N chia hết cho 3 và 7\nN nhập từ bàn phím\n\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_4T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
