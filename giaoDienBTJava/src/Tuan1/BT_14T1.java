 ...
 * @author menbt
 */
public class BT_14T1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Dãy Fibonaxi 1, 2, 3, … F(k) = F(k-1) + F(k-2). Tính số Fibonaxi thứ N.\nN nhập từ bàn phím");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_14T1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
