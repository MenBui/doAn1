 ...
 * @author menbt
 */
public class BT_5T3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Cho một xâu ký tự bao gồm toàn các ký tự 0,1. Hãy biến đổi xâu này theo cách 01, 10 và in ra kết quả.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_5T3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
