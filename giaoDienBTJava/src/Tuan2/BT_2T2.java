 ...
 * @author menbt
 */
public class BT_2T2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Cho dãy số tự nhiên, in ra màn hình tất cả các số nguyên tố của dãy này.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_2T2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
