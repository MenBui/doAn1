 ...
 * @author menbt
 */
public class BT_1T2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Nhập 1 dãy số tự nhiên\nSắp xếp dãy này theo thứ tự giảm dần");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_1T2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
